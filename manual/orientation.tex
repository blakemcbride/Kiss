...
Files under the @code{src/main/webapp} directory represent the
front-end of the application.

All files under the @code{src/main/webapp/kiss} directory are part of
...
The included database is located in the @code{application} directory 
...
@code{src/main/webapp/index.html} In that file you will see two lines
