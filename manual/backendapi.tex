...
@code{KissWarning} is used to abort the web service due to some sort of likely user error.  An error message and possible error code are returned to the front-end.
