...
In order for the system to know where the source code to the
application is, a system environment variable (@code{KISS_DEBUG_ROOT}) must
be set.  The value of this environment variable should be the absolute
path of the root of the application source code.  The directory it indicates
