...
@emph{jars}) located at @code{src/main/core/org/kissweb/builder}.
@code{BuildUtils.java} is the build system utilities.  You should
never need to change this.  The other file, @code{Tasks.java}
represents all of the tasks to build your system.  If you need to
change something about the build process, this is where your changes
will go.
...
first check to see if it has already been done, and if so, it doesn't
