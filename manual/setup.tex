...
The @emph{Kiss} documentation consists of two pieces; this manual, and the detailed API documentation contained in the JavaDocs.
...
This manual may be created in two forms.  The first is as an HTML
file.  The system comes with this.  You can also generate a nicely
...
Both the HTML form of this manual and the JavaDocs can be accessed with your browser.  For example,
if the root of @emph{Kiss} is located at @code{/my/home/path/kiss} then you will be able to access the two 
manuals at the following two URL's:
