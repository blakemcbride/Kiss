...
If you are using an alternative data store (such as Perst or another
non-SQL database) for user management, you can force authentication
without configuring a SQL database by setting
