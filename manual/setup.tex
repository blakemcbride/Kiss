...
@enumerate
@item
Java JDK 8, 11, or 17.  (At present, @emph{Kiss} does not support Java 21.)
@item
...
@enumerate
@item
Java JDK 8, 11, or 17 for many OSs at:
@itemize @bullet
@item
...
Mac requirements may be obtained via the @emph{brew} package manager available at @*@uref{https://brew.sh}
