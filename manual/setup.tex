...
@itemize @bullet
@item
src/main/core (except src/main/core/builder/Tasks.java)
@item
...
After an update has been performed, you will want to run the following command to assure you get a clean build:

@example
./bld realclean           (Linux or macos)
     or
bld realclean             (Windows)
@end example
