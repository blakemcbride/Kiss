 ...
 * Date: 3/5/22
 */
public class GoogleTimeZone extends GoogleAPI {
     ...
     */
    public String getTimezone(double latitude, double longitude) throws IOException {
        String location = roundCoordinates(latitude, longitude);
     ...
     * @throws IOException if the API call fails
     */
    public String getTimezone(String address) throws IOException {
        double[] latLng = new GoogleGeocode(getValidAPIKey()).findGeoLocation(address);
        if (latLng == null)
            return null;
     ...
     * @throws IOException if the API call fails
     */
    public String getTimezone(String street1, String street2, String city, String state, String zip) throws IOException {
